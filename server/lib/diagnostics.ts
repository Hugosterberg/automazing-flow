...
const DB_PROBES: Array<{ id: string; label: string; table: string; column: string; migration: string }> = [
  ...
  { id: "db_marketing_campaign_snapshots", label: "marketing_campaign_snapshots table", table: "marketing_campaign_snapshots", column: "snapshot_date", migration: "20260704100000_marketing_campaign_snapshots.sql" },
